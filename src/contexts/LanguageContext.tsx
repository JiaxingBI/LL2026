...
const translations: Record<Language, Record<string, string>> = {
  ...
  zh: {
    ...
    'attendance.today': '今天',
    'attendance.totalWorkers': '员工总数',
    'attendance.scheduledSlice': '本班次人数',
    'attendance.overtimeSlice': '加班（本班次）',
    'attendance.leaveSlice': '请假（本班次）',
    'attendance.lastColorShift': '上一班（色班）',
    'attendance.actualArrivedPlanInternal': '实际到岗/计划（内部）',
    'attendance.actualArrivedPlanThirdParty': '实际到岗/计划（第三方）',
    'attendance.overtimeWorkers': '加班人数',
    'attendance.leaveWorkers': '请假人数',
